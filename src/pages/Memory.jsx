...
const Memory = () => {
    ...
    const nextPhoto = () => {
        setCurrentIndex((prev) => (prev + 1) % memoryPhotos.length);
    };

    const prevPhoto = () => {
        setCurrentIndex((prev) => (prev - 1 + memoryPhotos.length) % memoryPhotos.length);
    };
                    ...
                    <div className="navigation-controls text-center">
                        <div className="d-flex justify-content-center align-items-center gap-4">
                            ...
                            <div className="d-flex flex-column align-items-center">
                                ...
                                <div className="d-flex gap-2">
                                    {[currentIndex - 2, currentIndex - 1, currentIndex, currentIndex + 1, currentIndex + 2]
                                        .map((idx, i) => {
                                            const actualIdx = (idx + memoryPhotos.length) % memoryPhotos.length;
                                            return (
                                                <button
                                                    key={i}
                                                    ...
                                                    style={{
                                                        ...
                                                        height: '8px',
                                                        borderRadius: '4px',
                                                        background: idx === currentIndex ? 'var(--emerald)' : 'var(--silver)',
                                                        border: 'none',
                                                        transition: 'all 0.3s'
                                                    }}
                                                />
                            ...
                            <Button
                                ...
                                variant="primary"
                                className="btn-noble px-5 py-3"
                                style={{ background: 'linear-gradient(45deg, var(--emerald), var(--fianit))' }}
                            >
                                Далее →
                            </Button>
                        </div>
